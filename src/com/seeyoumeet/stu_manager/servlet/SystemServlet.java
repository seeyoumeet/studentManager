...
import com.seeyoumeet.stu_manager.entity.SystemInfo;
import com.seeyoumeet.stu_manager.entity.User;
import com.seeyoumeet.stu_manager.service.SystemService;
import com.seeyoumeet.stu_manager.util.VCodeGenerator;
...
public class SystemServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} else if("toAdminView".equalsIgnoreCase(method)){ // 重定向到管理员界面
